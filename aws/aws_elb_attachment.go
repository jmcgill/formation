...
type AwsElbAttachmentImporter struct {
}

// Lists all resources of this type
func (*AwsElbAttachmentImporter) Describe(meta interface{}) ([]*core.Instance, error) {
	return nil, nil
...
func (*AwsElbAttachmentImporter) Links() map[string]string {
