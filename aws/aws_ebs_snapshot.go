...
type AwsEbsSnapshotImporter struct {
}

// Lists all resources of this type
func (*AwsEbsSnapshotImporter) Describe(meta interface{}) ([]*core.Instance, error) {
	return nil, nil
...
func (*AwsEbsSnapshotImporter) Links() map[string]string {
