...
type AwsEcsClusterImporter struct {
}

// Lists all resources of this type
func (*AwsEcsClusterImporter) Describe(meta interface{}) ([]*core.Instance, error) {
	return nil, nil
...
func (*AwsEcsClusterImporter) Links() map[string]string {
