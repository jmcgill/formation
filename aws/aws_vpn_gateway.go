...
type AwsVpnGatewayImporter struct {
}

// Lists all resources of this type
func (*AwsVpnGatewayImporter) Describe(meta interface{}) ([]*core.Instance, error) {
	return nil, nil
...
func (*AwsVpnGatewayImporter) Links() map[string]string {
