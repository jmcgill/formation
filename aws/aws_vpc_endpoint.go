...
type AwsVpcEndpointImporter struct {
}

// Lists all resources of this type
func (*AwsVpcEndpointImporter) Describe(meta interface{}) ([]*core.Instance, error) {
	return nil, nil
...
func (*AwsVpcEndpointImporter) Links() map[string]string {
