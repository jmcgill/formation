...
type AwsRdsClusterImporter struct {
}

// Lists all resources of this type
func (*AwsRdsClusterImporter) Describe(meta interface{}) ([]*core.Instance, error) {
	return nil, nil
...
func (*AwsRdsClusterImporter) Links() map[string]string {
