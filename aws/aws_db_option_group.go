...
type AwsDbOptionGroupImporter struct {
}

// Lists all resources of this type
func (*AwsDbOptionGroupImporter) Describe(meta interface{}) ([]*core.Instance, error) {
	return nil, nil
...
func (*AwsDbOptionGroupImporter) Links() map[string]string {
