...
type AwsIamAccessKeyImporter struct {
}

// Lists all resources of this type
func (*AwsIamAccessKeyImporter) Describe(meta interface{}) ([]*core.Instance, error) {
	return nil, nil
...
func (*AwsIamAccessKeyImporter) Links() map[string]string {
