...
type AwsDbSnapshotImporter struct {
}

// Lists all resources of this type
func (*AwsDbSnapshotImporter) Describe(meta interface{}) ([]*core.Instance, error) {
	return nil, nil
...
func (*AwsDbSnapshotImporter) Links() map[string]string {
