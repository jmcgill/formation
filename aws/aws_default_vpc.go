...
type AwsDefaultVpcImporter struct {
}

// Lists all resources of this type
func (*AwsDefaultVpcImporter) Describe(meta interface{}) ([]*core.Instance, error) {
	return nil, nil
...
func (*AwsDefaultVpcImporter) Links() map[string]string {
