...
type AwsSsmActivationImporter struct {
}

// Lists all resources of this type
func (*AwsSsmActivationImporter) Describe(meta interface{}) ([]*core.Instance, error) {
	return nil, nil
...
func (*AwsSsmActivationImporter) Links() map[string]string {
