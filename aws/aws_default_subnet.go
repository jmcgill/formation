...
type AwsDefaultSubnetImporter struct {
}

// Lists all resources of this type
func (*AwsDefaultSubnetImporter) Describe(meta interface{}) ([]*core.Instance, error) {
	return nil, nil
...
func (*AwsDefaultSubnetImporter) Links() map[string]string {
