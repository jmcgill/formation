...
type AwsSsmParameterImporter struct {
}

// Lists all resources of this type
func (*AwsSsmParameterImporter) Describe(meta interface{}) ([]*core.Instance, error) {
	return nil, nil
...
func (*AwsSsmParameterImporter) Links() map[string]string {
