...
type AwsVpnConnectionImporter struct {
}

// Lists all resources of this type
func (*AwsVpnConnectionImporter) Describe(meta interface{}) ([]*core.Instance, error) {
	return nil, nil
...
func (*AwsVpnConnectionImporter) Links() map[string]string {
