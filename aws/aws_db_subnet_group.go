...
type AwsDbSubnetGroupImporter struct {
}

// Lists all resources of this type
func (*AwsDbSubnetGroupImporter) Describe(meta interface{}) ([]*core.Instance, error) {
	return nil, nil
...
func (*AwsDbSubnetGroupImporter) Links() map[string]string {
