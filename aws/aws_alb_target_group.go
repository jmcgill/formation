...
type AwsAlbTargetGroupImporter struct {
}

// Lists all resources of this type
func (*AwsAlbTargetGroupImporter) Describe(meta interface{}) ([]*core.Instance, error) {
	return nil, nil
...
func (*AwsAlbTargetGroupImporter) Links() map[string]string {
