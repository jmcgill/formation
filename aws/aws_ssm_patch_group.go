...
type AwsSsmPatchGroupImporter struct {
}

// Lists all resources of this type
func (*AwsSsmPatchGroupImporter) Describe(meta interface{}) ([]*core.Instance, error) {
	return nil, nil
...
func (*AwsSsmPatchGroupImporter) Links() map[string]string {
